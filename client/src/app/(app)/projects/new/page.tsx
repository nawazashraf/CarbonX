            ...
            {currentStep === 2 && (
              ...
              >
                ...
                <div
                  ...
                  className={`border-2 border-dashed rounded-2xl p-8 flex flex-col items-center justify-center min-h-[250px] transition-all duration-300 group cursor-pointer ${
                    dragActive
